...
public class Modul22Activity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.modul2_2);
        ...
        if (rdbhs.matches("EN")){
            ...
            jumlahPesanan = i.getStringExtra("msgJumlah");
            namatxt.setText(name);
            hargatotal.setText(jumlahPesanan);
        }else {
            name = i.getStringExtra("name");
            jumlahPesanan = i.getStringExtra("msgJumlah");
            namatxt.setText(name);
